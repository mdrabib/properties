                    ...
                    <table class="table table-centered table-striped dt-responsive nowrap w-100" id="products-datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="table-user">
                                    @if ($moderator->avatar !== "")
                                    <img src="{{ asset('uploads/profile/'.$moderator->avatar)}}" alt="table-user" class="me-2 rounded-circle">
                                    @else
                                    <img src="{{ asset('uploads/profile/avatar.webp')}}" alt="table-user" class="me-2 rounded-circle">
                                    @endif
                                    <a href="{{route('member.show',$moderator) }}" class="text-body fw-semibold">
                                        {{$moderator->name}}
                                    </a>
                                </td>
                                <td>
                                ...
                                <td class="d-flex">
                                    <a 
                                    href="{{route('member.edit',$moderator)}}"
                                     class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                     <form action="{{route('member.destroy',$moderator)}}" method="POST">
                                        @csrf
                                        @method('delete')
